...
import ru.aegoshin.daterangecalendar.listeners.GridChangeListener;
...
public class GridAdapter extends ArrayAdapter {
    ...
    private DateRangeCalendarData calendarData;
    ...
    public GridAdapter(@NonNull Context context, @NonNull DateRangeCalendarData calendarData, int shiftMonth, @Nullable DateSelectListener listener, GridChangeListener gridListener) {
